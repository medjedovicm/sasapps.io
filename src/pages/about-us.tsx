  ...
  return (
    <Layout location={location}>
      ...
      <div className="container about-us">
        ...
        <p>
          By combining these we get to what we are about, we use analytics to
          discover stories, patterns and trends in your data which will help you
          formulate ideas and create positive outcomes for the future.
        </p>
        ...
        <h1>Our Values</h1>
        <p>
          Our values are centred around what our people value in themselves as
          well as each other. We collectively strive to use our values to guide
          our decision making and our ways of working effectively with each
          other and our customers.
        </p>
        <h3 className="custom-heading">Trust</h3>
        <p>
          Our people are passionate about data analytics and are self-driven to
          keep up with current technology trends and improve on our skills. We
          are trusted by our customers and peers to be the best we can be and
          continuously improve ourselves and deliver optimal outcomes.{' '}
        </p>
        <h3 className="custom-heading">Win-Win approach</h3>
        <p>
          To achieve a win-win outcome, we become an extended part of your
          business and commit ourselves as if it were one of our own. We really
          understand that a win for you is also a win for us as much as a loss
          for you is also a loss for us. Your success ultimately leads to our
